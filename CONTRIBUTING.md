...
It's good to hear that you want to contribute to Ponydoc!

There are a number of ways to contribute to Ponydoc. As this document is a little long, feel free to jump to the section that applies to you currently:
...
For any feature requests or enhancements to Ponydoc, it is quite likely that you have to go through our [RFC process](https://github.com/ponylang/rfcs). Before opening or submitting any feature requests, please make sure you are familiar with the RFC process and follow the process as required.

If you submit a pull request to implement a new feature without going through the RFC process, it may be closed with a polite request to submit an RFC first.

## Bug report

First of all please [search existing issues](https://github.com/ponylang/ponydoc/issues) to make sure your issue hasn't already been reported. If you cannot find a suitable issue — [create a new one](https://github.com/ponylang/ponydoc/issues/new).
...
1. Fork the ponydoc repo. you can do this via the GitHub website. This will result in you having your own copy of the ponydoc repo under your GitHub account.
2. Clone your ponydoc repo to your local machine
...
We keep a [CHANGELOG](CHANGELOG.md) of all software changes with behavioural effects in ponydoc. If your PR includes such changes (rather than say a documentation update), a Pony team member will do the following before merging it, so that the PR will be automatically added to the CHANGELOG:
